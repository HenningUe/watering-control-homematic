...
from .. import actionstorage, consts

from . import entities, utils
from .exceptions import PMException, PMActionFailed
...
class Parameter(utils.CallbackMixin):
    ...
    def __init__(self, channel, spec):
        assert isinstance(channel, entities.Channel), \
    ...
    def _set_value(self, value):
        ...
        actionstorage.add_actuator_event(self)
        ...
        if value != old_value:
            ...
            time.sleep(consts.ActorConstants.dauer_uebertragung_an_geraet)
