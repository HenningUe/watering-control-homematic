...
from .ccu import utils
from .ccu import CCU  # noqa
from .exceptions import PMException, PMConnectionError, \
...
def logging(log_level=None):
    ...
    """
    global logger_default_handler, logger
    ...
    # formatter = _logging.Formatter('%(relativeCreated)s [%(levelname)s] %(message)s')
