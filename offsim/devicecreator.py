...
def create_devices(ccu):
    ...
    spec[u"name"] = u"BewaesserungRelais1"
    spec[u"address"] = get_address()
    bewaesserung_relais_1 = entities.Device.from_dict(ccu, spec)
    channels_spec_dict = [
        {u"type": u"MAINTENANCE",
         u"address": get_address(),
         u"index": get_index(reset=True)},
        {u"type": u"SWITCH",
         u"name": u"BewaesserungRelais1_Kanal1",
         u"alias": u"VentHaupt",
         u"address": get_address(),
         u"index": get_index()},
        {u"type": u"SWITCH",
         u"name": u"BewaesserungRelais1_Kanal2",
         u"alias": u"VentEntwaess",
         u"address": get_address(),
         u"index": get_index()},
        {u"type": u"SWITCH",
         u"name": u"BewaesserungRelais1_Kanal3",
         u"alias": u"VentBewSued",
         u"address": get_address(),
         u"index": get_index()},
        {u"type": u"SWITCH",
         u"name": u"BewaesserungRelais1_Kanal4",
         u"alias": u"VentBewWest",
         u"address": get_address(),
         u"index": get_index()}]
    channels = entities.Channel.from_channel_dicts(bewaesserung_relais_1, channels_spec_dict)
    bewaesserung_relais_1.channels = channels
    ccu.devices.add(bewaesserung_relais_1)
    for ch in channels:
        ch.values[u"STATE"] = params.Parameter(ch, {u"operations": 7,
                                                    u"default": 0})
        ccu.devices.add(ch)
