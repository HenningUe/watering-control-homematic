...
def adapt_csts():
    ...
    zcsts.autobewsrng_max_bewaesserungs_zeit = 15
    zcsts.autobewsrng_max_delta_zeit_zwischen_balkonen = 20
    zcsts.autobewsrng_max_zeiten_ohne_bewaesserung = [30, 40, 75]

    from bewaesserung import AutoWateringBalconies
