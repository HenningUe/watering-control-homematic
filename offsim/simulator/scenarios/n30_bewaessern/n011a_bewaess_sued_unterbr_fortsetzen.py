...
#                consts.TimeConstants.dauer_bewaesserung_sued)
    time.sleep(consts.ActorConstants.dauer_relais_schalten * 2 +
               consts.TimeConstants.dauer_bewaesserung_sued * 0.5)
    _sensortrigger.trigger_event_but_short(_MyDevices.schalter_wozi_1.switch_middle_left)
...
def _create_byhand_plot():
    ...
    ### Sensoren ..
    #Schalter Garage
    _plotbyhand.add_sensor_event(_MyDevices.schalter_wozi_1.switch_middle_left)
