...
def _run_scenario():
    # bug: time_sleep = 0.5
    consts.ActorConstants.dauer_relais_schalten = 0.5
    consts.ActorConstants.dauer_uebertragung_an_geraet = 0.5
    time_sleep = 0.8
    for _ in xrange(8):
...
def run():
    import bewaesserung
    bewaesserung.AutoBewaesserung.is_autobewaesserung_enabled = False
    bewaesserung.run(simulate)
