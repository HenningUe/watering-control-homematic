...
def _run_scenario():
    ...
    sensortrigger.trigger_event_but_short(_MyDevices.schalter_wozi_1.switch_top_right)
#     time.sleep(consts.ActorConstants.dauer_relais_schalten * 0.2)
#     sensortrigger.trigger_event_but_short(_MyDevices.schalter_wozi_1.switch_top_right)
#     time.sleep(consts.ActorConstants.dauer_relais_schalten * 0.2)
#     sensortrigger.trigger_event_but_short(_MyDevices.schalter_wozi_1.switch_top_right)
    time.sleep(consts.ActorConstants.dauer_relais_schalten * 3.0 +
               consts.TimeConstants.autowatering_max_watering_time)
    sensortrigger.trigger_event_but_short(_MyDevices.schalter_wozi_1.switch_middle_right)
    time.sleep(consts.ActorConstants.dauer_relais_schalten * 0.8)
    sensortrigger.trigger_event_but_short(_MyDevices.schalter_wozi_1.switch_middle_right)
    time.sleep(consts.ActorConstants.dauer_relais_schalten * 0.3)
    sensortrigger.trigger_event_but_short(_MyDevices.schalter_wozi_1.switch_middle_left)
...
def _create_byhand_plot():
    ...
    # ## Sensoren ..
    # Schalter Garage
    plotbyhand.add_sensor_event(_MyDevices.schalter_wozi_1.switch_top_right)
