...
#     time.sleep(consts.ActorConstants.dauer_relais_schalten * 5.5 +
#                consts.TimeConstants.dauer_watering_sued)
...
def _create_byhand_plot():
    ...
    # ## Sensoren ..
    # Schalter Garage
    plotbyhand.add_sensor_event(_MyDevices.schalter_wozi_1.switch_middle_left)
